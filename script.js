...
function chooseCriteria() {
  ...
  // if(passwordLength >= 8)
  // create confirm for specialChar
  // create confirm for numeric
  // create confirm for lowerCase
  // create confirm for upperCas
...
// create a function that takes you to inputs based on char choice & password length
